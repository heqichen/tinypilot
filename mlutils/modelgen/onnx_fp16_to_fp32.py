...
def convert_model_to_fp32(model_path: str, out_path: str):
    ...
    """
    print("ONNX FLOAT16 --> FLOAT32 Converter")
    ...
    print("Converting FLOAT16 model params to FLOAT32...")
    # * convert all FLOAT16 aprams to FLOAT32.
    converted_params = convert_params_to_fp32(params_dict)
    print("Converting constant FLOAT16 nodes to FLOAT32...")
    ...
    print("Creating new float32 model...")
