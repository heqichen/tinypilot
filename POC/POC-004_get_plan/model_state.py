...
model_basedir = "/home/heqichen/workspace/tinypilot/POC/resources/models"
DRIVING_VISION_METADATA = model_basedir + "/driving_vision_metadata.pkl"
DRIVING_POLICY_METADATA = model_basedir + "/driving_policy_metadata.pkl"
DRIVING_VISION_ONNX = model_basedir + "/driving_vision.onnx"
DRIVING_POLICY_ONNX = model_basedir + "/driving_policy.onnx"
